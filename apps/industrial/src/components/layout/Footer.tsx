...
const SOCIAL_ITEMS = [
  { href: SOCIAL.linkedin, label: "Perfil de LinkedIn de Voltac Industrial", Icon: LinkedinIcon },
  { href: SOCIAL.instagram, label: "Perfil de Instagram de Voltac Industrial", Icon: InstagramIcon },
  { href: SOCIAL.facebook, label: "Página de Facebook de Voltac Industrial", Icon: FacebookIcon },
  { href: SOCIAL.x, label: "Perfil de X de Voltac Industrial", Icon: XIcon },
];
