...
const NAV_LINKS = [
  /* Proyectos y Noticias todavia no existen en esta linea: se alimentan del
     panel, que aun no se monta aqui. Un enlace en el menu a una ruta que
     devuelve 404 hace mas dano que la seccion que falta. Se reactivan cuando
     haya panel. */
  { name: "Inicio", href: "/" },
