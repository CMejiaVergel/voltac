...
export const metadata: Metadata = {
  title: "Servicios",
  description:
    "Servicios de mantenimiento industrial, control e instrumentación: calibración con certificado trazable, sintonía de lazos, SCADA, mantenimiento predictivo con termografía y vibraciones, tableros eléctricos, calidad de energía y paradas de planta.",
  keywords: [
    "instrumentación industrial cartagena",
    "calibración de instrumentos certificado trazable",
    "mantenimiento predictivo termografía vibraciones",
    "sintonía de lazos de control PID",
    "SCADA y automatización industrial colombia",
    "estudio de calidad de energía IEC 61000-4-30",
...
const serviceCatalogSchema = {
  ...
  "@type": "ItemList",
  name: "Portafolio de servicios Voltac Industrial 2026",
  description:
    "Servicios de mantenimiento industrial, control e instrumentación orientados a sostener la disponibilidad de planta y a respaldar la operación con mediciones y documentación.",
  itemListElement: SERVICES.map((svc, i) => ({
    ...
    item: {
      ...
      areaServed: ["Colombia"],
      provider: { "@type": "Organization", name: "Voltac Industrial" },
    },
  })),
};
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mb-10 md:mb-16">
            ...
            <TextReveal
              as="h2"
              className="display-2"
              segments={[{ text: "De la visita" }, { text: "al arranque.", highlight: true }]}
            />
          </div>
      ...
      <section className="py-16 sm:py-20 md:py-24 bg-muted border-y border-border/50">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mb-10 md:mb-16">
            ...
            <Reveal delay={0.15}>
              <p className="lead text-secondary/70">
                Los términos que va a escuchar en cualquier conversación técnica, explicados
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <Reveal delay={0.15}>
            <p className="lead mb-10 opacity-90 max-w-2xl mx-auto">
              Cuéntenos qué equipo o qué proceso lo tiene preocupado. Vamos a su planta, lo miramos
              y le decimos con franqueza si hay algo que valga la pena intervenir, qué costaría y
              qué recupera. La visita es sin costo y sin compromiso.
            </p>
          </Reveal>
          <Reveal delay={0.25}>
            <Link href="/cotizar">
