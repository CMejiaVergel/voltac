...
export const metadata: Metadata = {
  ...
  title: {
    default: "Voltac Industrial | Mantenimiento, control e instrumentación",
    template: "%s | Voltac Industrial"
  },
  ...
  openGraph: {
    ...
    locale: 'es_CO',
    url: CONTACT.site,
    siteName: 'Voltac Industrial',
    images: [{ url: '/servicios/hero.webp', width: 2000, height: 1166, alt: 'Voltac Industrial - Mantenimiento, control e instrumentacion' }],
  },
...
const organizationSchema = {
  ...
  "areaServed": ["Colombia"],
  "knowsLanguage": "es",
  "image": `${CONTACT.site}/servicios/hero.webp`,
  "priceRange": "$$",
  "address": {
    "@type": "PostalAddress",
