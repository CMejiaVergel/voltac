...
export function SpotlightCard({
  ...
  const glow = useMotionTemplate`radial-gradient(${radius}px circle at ${mouseX}px ${mouseY}px, rgba(251, 139, 46,${intensity}), transparent 72%)`;
  const border = useMotionTemplate`radial-gradient(${radius * 0.8}px circle at ${mouseX}px ${mouseY}px, rgba(251, 139, 46,0.55), transparent 70%)`;
