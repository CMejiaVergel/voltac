...
// Colores de Voltac Industry escritos como valores, no como variables CSS:
// esto pinta en un <canvas>, que no sabe leer var(--accent). Son el ambar
// de acento (#fb8b2e) y un tono mas claro para la cabeza de cada pulso.
// Si la paleta cambia en globals.css, hay que cambiarlos aqui tambien.
    ...
    const draw = () => {
      ...
      for (let i = 0; i < cols; i++) {
        for (let j = 0; j < rows; j++) {
          ...
          ctx.fillStyle = `rgba(251, 139, 46, ${alpha})`;
          ctx.beginPath();
      ...
      for (let p = 0; p < pulses.length; p++) {
        ...
        gradient.addColorStop(0, "rgba(251, 139, 46, 0)");
        gradient.addColorStop(0.75, "rgba(251, 139, 46, 0.45)");
        gradient.addColorStop(1, "rgba(255, 176, 112, 0.95)");
