...
const SOCIAL_ITEMS = [
  { href: SOCIAL.linkedin, label: "Perfil de LinkedIn de Voltac Industry", Icon: LinkedinIcon },
  { href: SOCIAL.instagram, label: "Perfil de Instagram de Voltac Industry", Icon: InstagramIcon },
  { href: SOCIAL.facebook, label: "Página de Facebook de Voltac Industry", Icon: FacebookIcon },
  { href: SOCIAL.x, label: "Perfil de X de Voltac Industry", Icon: XIcon },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8 pb-12">
          ...
          <div className="max-w-md space-y-5">
            ...
            <p className="text-white/60 leading-relaxed font-light">
              Mantenimiento industrial, control automático e instrumentación. Medimos antes de
              que falle, intervenimos dentro de su ventana de producción y dejamos todo documentado.
            </p>
            {socials.length > 0 && (
