      ...
      >
        <motion.div className="absolute inset-0 z-0" style={reduced ? undefined : { y: bgY }}>
          <Image
            ...
            alt="Red de tuberías y válvulas de proceso en una planta industrial"
            fill
            ...
            priority
          />
          {/* La foto del hero es gris y metalica: con el velo del 85% que usa la
              linea de software quedaba practicamente negra y no se reconocia
              nada. Se baja el velo y se concentra el degradado abajo, que es
              donde de verdad hace falta contraste para el texto. */}
          <div className="absolute inset-0 bg-secondary/55 mix-blend-multiply" />
          <div className="absolute inset-0 bg-gradient-to-b from-secondary/70 via-secondary/45 to-secondary" />
        </motion.div>
        ...
        >
          <div className="max-w-3xl text-white">
            ...
            <TextReveal
              ...
              delay={0.1}
              segments={[
                { text: "Su planta no debería" },
                { text: "parar por sorpresa.", highlight: true },
              ]}
            />
            ...
            >
              Mantenimiento, control e instrumentación para lo que sostiene su producción. Medimos
              antes de que falle, intervenimos dentro de su ventana y dejamos todo documentado.
            </motion.p>
            ...
            >
              Visita técnica sin costo · Trabajamos dentro de su ventana de producción
            </motion.p>
          </div>
        </motion.div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-6 relative">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-6 mb-12 md:mb-16">
            ...
            <Reveal delay={0.2} className="shrink-0">
              <Link
                href="/servicios"
                className="font-semibold text-primary-ink hover:text-primary uppercase tracking-wider inline-flex items-center gap-2 group transition-colors text-sm"
              >
                Ver el portafolio
            ...
            <RevealItem className="md:col-span-2 lg:col-span-3">
              <SpotlightCard className="group h-full overflow-hidden rounded-2xl bg-muted border border-border/50 hover:border-primary/30 hover:shadow-2xl transition-all duration-500 card-pad md:p-10 flex flex-col md:flex-row gap-6 md:gap-8 md:items-center">
                ...
                <div className="flex-1 relative">
                  ...
                  <span className="mt-4 text-xs font-bold uppercase tracking-wider text-primary-ink inline-flex items-center gap-2">
                    Ver en detalle
                ...
                <ServiceImage
                  ...
                  priority
                  className="relative w-full md:w-[280px] shrink-0"
                />
              </SpotlightCard>
            </RevealItem>
              ...
              return (
                <RevealItem key={service.slug}>
                  <SpotlightCard className="group card-pad h-full rounded-2xl bg-muted border border-border/50 hover:bg-white hover:shadow-2xl hover:border-primary/30 transition-all duration-500 overflow-hidden flex flex-col">
                    ...
                    />
                    {/* Fotografía del servicio con el icono y el número superpuestos */}
                    <ServiceImage service={service} className="relative mb-5">
                    ...
                    <span className="relative mt-auto pt-2 text-xs font-bold uppercase tracking-wider text-primary-ink inline-flex items-center gap-2 lg:opacity-0 lg:group-hover:opacity-100 lg:-translate-x-2 lg:group-hover:translate-x-0 transition-all duration-300">
            ...
            <div className="mt-6 relative overflow-hidden rounded-2xl bg-ink text-white card-pad md:p-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
              ...
              <div className="relative max-w-2xl">
                ...
                <p className="text-white/60 font-light text-sm md:text-base leading-relaxed">
                  Empecemos por una visita técnica a su planta, sin costo. Le decimos con franqueza
                  si hay algo que valga la pena intervenir.
                </p>
              </div>
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            <div className="space-y-8">
              <TextReveal
                as="h2"
                className="display-2"
                segments={[{ text: "¿Por qué" }, { text: "Voltac Industry?", highlight: true }]}
              />
              <Reveal delay={0.1}>
                <p className="lead text-white/70">
                  Venimos de planta, y de ahí viene nuestra forma de trabajar: primero se entiende
                  el proceso y después se elige el equipo. Nunca al revés. El resultado es siempre el
                  mismo: menos paradas imprevistas, menos reprocesos y una operación que se sostiene
                  sin depender de que alguien esté mirando.
                </p>
              </Reveal>
            ...
            <Reveal direction="left" distance={40} delay={0.15}>
              <div className="relative h-[280px] sm:h-[380px] lg:h-[600px] rounded-2xl overflow-hidden border border-white/10 shadow-[0_0_50px_rgba(242, 101, 17,0.15)] group">
                <Image
                  src="/servicios/montaje.webp"
                  alt="Técnico con arnés y casco trabajando en equipo de altura"
                  fill
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="text-center mb-12 md:mb-16 max-w-2xl mx-auto">
            ...
            <TextReveal
              ...
              segments={[{ text: "Plantas donde" }, { text: "ya trabajamos.", highlight: true }]}
            />
            <Reveal delay={0.12}>
              <p className="lead text-secondary/60">
                El instrumento se parece de un sector a otro. Lo que cambia es qué pasa cuando falla.
              </p>
            </Reveal>
          </div>
          ...
          <Reveal delay={0.1} className="mt-16 text-center">
            <Link href="/servicios">
              ...
              >
                Ver el portafolio completo <Activity size={16} />
              </Button>
            </Link>
          </Reveal>
        </div>
            ...
            <div ref={ctaRef} className="bg-secondary text-white rounded-[2rem] p-8 sm:p-10 md:p-16 relative overflow-hidden">
              ...
              <div className="relative z-10 max-w-3xl">
                <TextReveal
                  ...
                  segments={[{ text: "Empecemos por una" }, { text: "visita a su planta.", highlight: true }]}
                />
                <Reveal delay={0.15}>
                  <p className="lead text-white/70 mb-10">
                    Cuéntenos qué equipo lo tiene preocupado, qué lazo terminó en manual o qué
                    parada se les alargó la última vez. Vamos, lo miramos y le decimos con franqueza
                    si hay algo que valga la pena intervenir, qué costaría y qué recupera. Sin costo
                    y sin compromiso.
                  </p>
                </Reveal>
                <Reveal delay={0.25}>
